...
class UsersAdmin extends Controller
{
                ...
                case '3': //otros
                    $infoTable['header'] .= '
                        <th class="column1">#</th>
									...
									<th class="column12">Modo Administrador</th>
									<th >Editar</th>
									<th >Ver</th>
									<th >Estatus</th>
									<th >Foto</th>
                    ...
                    foreach ($rows as $user) {
				        ...
				        if($user->Modo_Admin)
				        	$infoTable['body'].= '<td class="modoDios column12">ACTIVADO</td>';
				        
				        else
				        	$infoTable['body'].= '<td class="column12">DESACTIVADO</td>';
        ...
        if ($tipo_export == 'EXCEL') {
            ...
            switch ($filtroActual) {
                ...
                case '3':
					...
					$csv_data="#,User Name,Nombre completo,Correo,Area,Jurídico,Dictamen_M,Remisiones,Inspecciones,Inteligencia_Op,IPH_Final,Seguimientos,Evento D,Modo Admin\n";
    ...
    public function generateDropdownColumns($filtro=1){
        ...
        switch ($filtro) {
            case '1':
                $campos = ['Id usuario','Username','Nombre','Jurídico','Dictamen','Remisiones','Inteligencia','Inteligencia Op','IPH Final','Seguimientos','Eventos delictivos','Modo administrador'];
            break;
            case '2':
                $campos = ['Id usuario','Username','Nombre','Jurídico','Dictamen','Remisiones','Inteligencia','Inteligencia Op','IPH Final','Seguimientos','Eventos delictivos','Modo administrador'];
            break;
