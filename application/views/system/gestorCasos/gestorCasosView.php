...
<div class="container mt-5 mb-3">
    <div class="row">
        <div class="col-auto mr-auto my-auto">
            <h5 class="title-width my-auto">Atlas Delictivo</h5>
        </div>
        <div class="col-auto my-auto ">
            <a class="btn btn-opacity <?= ($_SESSION['userdata']->Seguimientos[3])?'':'mi_hide';?>" href="<?= base_url;?>GestorCasos/nuevo" >Nuevo Grupo Delictivo</a>
        </div>
    </div>
