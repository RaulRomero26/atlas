    ...
    <input type="hidden" name="no_grupo" id="no_grupo" value=<?= $no_grupo ?>>
        <div class="form-row mt-5">
            ...
            <div class="form-group col-lg-6">
                ...
                <textarea rows="6" maxlength="450" class="form-control form-control-sm text-uppercase" id="delitos_asociados" name="delitos_asociados" ></textarea>
                <span class="span_error" id="delitos_asociados_error"></span>
            </div>

            <div class="form-group col-lg-6">
                <label for="modus_operandi" class="label-form">Modus operandi:</label>
                <textarea rows="6" type="number" class="form-control form-control-sm" id="modus_operandi" name="modus_operandi" maxlength="2" ></textarea>
